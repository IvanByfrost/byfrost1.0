<div class="root-dashboard">
    <div class="root-sidebar">
        <ul>
            <li><a href="<?php echo url; ?>"><i data-lucide="home"></i>Inicio</a></li>
            <li><a href="<?php echo url; ?>#"><i data-lucide="school"></i>Colegios</a></li>
            ...
            <li><a href="<?php echo url; ?>#"><i data-lucide="user"></i>Usuarios</a></li>
