...
window.loadView = function(viewName) {
    console.log('loadView llamado desde períodos con:', viewName);
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-3 mb-4 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group me-2">
                        ...
                        <button type="button" class="btn btn-primary" onclick="loadView('payroll/createPeriod')">
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <button type="button" class="btn btn-sm btn-outline-info" 
                                                            onclick="loadView('payroll/viewPeriod?id=<?php echo $period['period_id']; ?>')"
                                                            title="Ver Detalles">
                                                        <i class="fas fa-eye"></i>
                                                    </button>
                                                    <?php if ($sessionManager->hasRole(['root', 'director', 'treasurer'])): ?>
                                                    <button type="button" class="btn btn-sm btn-outline-primary" 
                                                            onclick="loadView('payroll/editPeriod?id=<?php echo $period['period_id']; ?>')"
                                                            title="Editar">
