    ...
    <?php
    // Cargar script específico del profesor si es necesario
    ...
    <?php
    // Cargar script específico del administrador si es necesario
    if ($userRole === 'root'):
    ?>
    ...
    <script type="text/javascript" src="<?php echo url . app . rq ?>js/test-onlyNumbers.js"></script>
    </body>
