    ...
    <div class="row">
        <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="credential_number" name="credential_number" placeholder="Ingrese el número de documento" required>
                                </div>
                            </div>
            ...
            <div class="card d-none" id="searchResultsCard">
                <div class="card-header">
                    <h5 class="card-title mb-0">Usuarios Encontrados</h5>
                </div>
            ...
            <div class="modal-body">
                <form id="assignRoleForm">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="modal_role_type" name="role_type" required>
