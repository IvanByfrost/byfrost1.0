...
<form method="GET" id="consultSchool" class="dash-form" action ="<?php echo url . rq ?>app/processes/schoolProcess.php">
    ...
    <ul>
        ...
        <div class="col- 12 input-group">
            <input type="text" id="school_name" name="school_name" class="inputEstilo1" placeholder="Nombre del colegio">
        </div>
        <div class="input-group">
            <input type="text" id="codigoDANE" name="codigoDANE" class="inputEstilo1" placeholder="Código DANE del colegio">
        </div>
    </ul>
    <div class="col-6">
