...
<head>
    ...
    <title>Test Director Inicio</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-4">
        <h1>Test Director Inicio</h1>
        <p>Verificando que el enlace "Inicio" del director carga correctamente</p>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <button class="btn btn-primary mb-2 w-100" onclick="testDirectorInicio()">Test Inicio Director</button>
                        <button class="btn btn-success mb-2 w-100" onclick="testDirectorDashboard()">Test Director Dashboard</button>
                        <button class="btn btn-info mb-2 w-100" onclick="testPayrollDashboard()">Test Payroll Dashboard</button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        // Funciones de prueba
        function testDirectorInicio() {
            console.log('=== Probando Inicio Director ===');
            console.log('Cargando: director/dashboard');
            loadView('director/dashboard');
        }
        
        function testDirectorDashboard() {
            console.log('=== Probando Director Dashboard ===');
            console.log('Cargando: directorDashboard');
            loadView('directorDashboard');
        }
        
        function testPayrollDashboard() {
            console.log('=== Probando Payroll Dashboard ===');
