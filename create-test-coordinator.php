<?php
/**
 * Script para crear un usuario de prueba con rol de coordinador
 */

echo "<h1>Crear Usuario de Prueba - Coordinador</h1>";
...
try {
    ...
    if ($stmt->fetch()) {
        ...
        echo "<p><strong>Rol:</strong> coordinator</p>";
    } else {
        // Crear el usuario
...
echo "<li>Ve a <a href='http://localhost:8000/?view=coordinator&action=dashboard' target='_blank'>Dashboard Coordinador</a></li>";
echo "</ol>";
